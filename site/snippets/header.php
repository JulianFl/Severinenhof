    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        <ul class="navbar-nav ">
            <li class="nav-item active">
                <a class="nav-link " href="/home/"><!--<span class="sr-only">(current)</span>-->Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/aktuelles/">Aktuelles</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/der-severinenhof/" ><!--id="navbarDropdownMenuLink" data-toggle="dropdown" <!--aria-haspopup="true" aria-expanded="false">-->
                    Der Severinenhof
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/ferienwohnungen/"> <!--data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"-->
                    Ferienwohnungen
                </a>
